 ...
 * @LastEditors: px
 * @LastEditTime: 2022-03-31 09:42:59
-->
<template>
    <div class="check">
        <el-dialog v-model="showCheck" title="日报审核" width="28%" center="true">
            <el-form ref="showcheckform" :model="checkDate" :rules="rules" label-width="120px" >
                <el-form-item label="部门" prop="organizationName">
                    <el-input v-model="checkDate.organizationName" disabled="true" style="width:280px;" />
                </el-form-item>
                <el-form-item label="任务名称" prop="name">
                    <el-input v-model="checkDate.name" disabled="true" style="width:280px;" />
                </el-form-item>
                <el-form-item label="时间段" prop="date">
                    <el-input v-model="checkDate.date" disabled="true" style="width:280px;" />
                </el-form-item>
                <el-form-item label="任务消耗人天" prop="time">
                    <el-input v-model="checkDate.time" style="width:280px;" />
                </el-form-item>
                <el-form-item label="日报备注" prop="remark">
                    <el-input v-model="checkDate.remark" type="textarea" style="width:280px;" disabled="true" />
                </el-form-item>
