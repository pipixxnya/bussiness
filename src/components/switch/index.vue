<template>
  <div class="dl-switch" :class="{ 'is-checked': checked }">
    <input class="dl-switch__input" ref="input" type="checkbox" :checked="checked" @change="handleInput" :true-value="trueValue" :false-value="falseValue" />
    <span class="dl-switch_action"></span>
  </div>
</template>
<script lang="ts">
export default {
...
.dl-switch.is-checked {
  background: #409eff;
}

.is-checked .dl-switch_action {
  left: 100%;
  background: #fff;
  margin-left: -12px;
}
